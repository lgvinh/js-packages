...
import { ApiOptions, ApiRequest, IRestApiClient, QueryParams, Result } from "domains";

export class AxiosApi implements IRestApiClient {

    protected url: string;
    constructor(protected readonly source: string, protected readonly axios: AxiosInstance) {
    ...
    async find(query: QueryParams, options?: ApiOptions): Promise<Result<unknown[]>> {
        try {
